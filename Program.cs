...
*/
    ...
    { // Характеристики товара:
        ...
        public double Prices // my svoistvo    
        {
            set
            {
                if (unit_price >= 0)
    ...
    { // Функция Main демонстрирует cоздание объектов и работу с ними.
        public static void Main(String[] args) ////////////////////////////////////////////////////////////////////////////////
        {
            ...
            Item pampers = new Item("детское-001", "Подгузники набор", 5, 10.50);

            // применение дисконтной карты - предоставлена скидка только на стоимость молока
            milk.Discount = 0.15;
            pampers.Discount = 0.40;
            ...
            double pampers_price = pampers.Adjusted_Total();
            double pamp_priceper1item = pampers.Prices;
            // напечатать квитанцию
            Console.Clear();
            Console.WriteLine("Благодарю Вас за ваши покупки.");
            Console.WriteLine("Пожалуйста, приходите снова!\n");
            Console.WriteLine(milk.Discount + "\t\t" + milk.Quantity + "\t\t" + milk.Description + "\t $" + milk_price);
            ...
            Console.WriteLine(pampers.Discount + "\t\t" + pampers.Quantity + "\t\t" + pampers.Description + "\t $" + pampers_price +
            " цена за штуку:" + pamp_priceper1item);

            // подсчитать и напечатать сумму - стоимость всей покупки
            double total = milk_price + yogurt_price + bread_price + soap_price + pampers_price;
